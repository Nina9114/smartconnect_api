...
- **Base de Datos:** MySQL 8.0 (instalado directamente en EC2)
- **Servidor WSGI:** Gunicorn
- **URL Pública:** `http://18.234.1.99/api/info/`
- **IP Pública:** `18.234.1.99`
- **Puerto:** 8000 (o 80 si usas Nginx)
...
- Muestra la respuesta JSON desde la IP pública: `http://18.234.1.99/api/info/`
...
- Muestra conexión exitosa a MySQL (`mysql -u smartconnect_user -p`)
- O muestra las tablas creadas (`SHOW TABLES;`)
- O muestra la estructura de una tabla (`DESCRIBE api_departamento;`)
...
curl -H "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGc..." \
     http://18.234.1.99/api/departamentos/
```
...
3. **Navegador:**
   - Abre `http://18.234.1.99/api/info/`
