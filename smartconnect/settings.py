...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%c$@)r)_w64p(r^(&s1=db9^=v9u&bw&@d&wp1(+(=t8*cqwyn')
...
handler404 = 'smartconnect.views.handler404'
handler500 = 'smartconnect.views.handler500'
...
if not DEBUG:
    ...
    # Si usas HTTPS, descomenta estas líneas:
